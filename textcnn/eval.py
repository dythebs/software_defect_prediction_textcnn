...
# Data Parameters
tf.flags.DEFINE_string("valid_data_file", "../data/test.txt", "Data source for the positive data.")
tf.flags.DEFINE_string("w2v_file", "../data/vectors.bin", "w2v_file path")

# Eval Parameters
tf.flags.DEFINE_integer("batch_size", 256, "Batch Size (default: 64)")
tf.flags.DEFINE_string("checkpoint_dir", "./runs/1531336778/checkpoints/", "Checkpoint directory from training run")
...
def load_data(w2v_model,max_document_length = 0):
...
def eval(w2v_model):
    ...
    with graph.as_default():
        ...
        with sess.as_default():
            ...
            x_test, y_test = load_data(w2v_model,1404)
